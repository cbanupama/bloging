                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="title"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Post title') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="body"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Post body') }}</label>
                            ...
                            <div class="form-group row" id="image-wrapper">
                                <label for="image"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Post image') }}</label>
                            ...
                            <div class="form-group row" id="youtube-wrapper">
                                <label for="youtube_link"
                                       class="col-md-4 col-form-label text-md-right">{{ __('Post youtube link') }}</label>

                                <div class="col-md-6">
                                    <input id="youtube_link" type="url"
